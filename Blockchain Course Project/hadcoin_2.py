    ...
    def replace_chain(self):
        ...
        for node in network:
            ...
            if response.status_code == 200:
                ...
                length = response.json()[0][0]['length']
                chain = response.json()[0][0]['chain']
...
#Creating an address for the node on Port 3000
...
def mine_block():
    ...
    blockchain.add_transactions(node_address, 'Shravan', 7)
